...
mod tests {
    use crate::constants::{
        ...
        TEST_STABLE_COMMISSION_PERCENT, TEST_TRANSACTION_ID,
    };
    use crate::utils::{
    ...
    use contract_bridge::entry_points::{EP_CHECK_PARAMS, PARAM_BYTES, PARAM_SIGNATURE, PARAM_TRANSACTION_ID};
